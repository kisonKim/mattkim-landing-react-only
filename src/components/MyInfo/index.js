      ...
      <LeftBox>
        <InfoBox {...InfoBoxAnim}>
          ...
          <div className="portfolios">
            <h2> PORTFOLIOS </h2>
            <ul> 
              <li><a href={"https://www.briphy.com"} rel="noreferrer" target={"_blank"}>브리피 LandingPage - ReactJS, Docker, PHP</a></li> 
              <li><a href={"https://kisonkim.github.io/scroll_anim_web/"} rel="noreferrer" target={"_blank"}>브리피 Scroll Animation Web - Vanilla JS</a></li> 
